#' @title MAR_MethodC
#' @description This function will call the \code{generateData} and \code{MAR} function to generate the dataset under MAR with certain missing rate,use method C for analysis, repeate for 1000 iterations and return the beta, betaSE, meanBias, meanError, cover for each iteration
